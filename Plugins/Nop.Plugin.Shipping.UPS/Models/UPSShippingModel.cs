...
namespace Nop.Plugin.Shipping.UPS.Models
{
    public class UPSShippingModel
    {
        ...
        [NopResourceDisplayName("Plugins.Shipping.UPS.Fields.IsLiveRates")]
        public bool IsLiveRates { get; set; }
        [NopResourceDisplayName("Plugins.Shipping.UPS.Fields.isusafreeshipping")]
        public bool isusafreeshipping { get; set; }
        [NopResourceDisplayName("Plugins.Shipping.UPS.Fields.iscontigousfreeshipping")]
        public bool iscontigousfreeshipping { get; set; }
        public List<string> ShippingRate { get; set; }
    }
}