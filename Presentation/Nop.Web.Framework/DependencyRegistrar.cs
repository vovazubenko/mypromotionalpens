...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<RestrictionDomainService>().As<IRestrictionDomainService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ASI_SuppliersUpdateStatusService>().As<IASI_SuppliersUpdateStatusService>().InstancePerLifetimeScope();
            builder.RegisterType<ASI_ProductsCSVGenerationRequestService>().As<IASI_ProductsCSVGenerationRequestService>().InstancePerLifetimeScope();


            builder.RegisterType<PurchaseOrderService>().As<IPurchaseOrderService>().InstancePerLifetimeScope();
            builder.RegisterType<ZohoDeskApi>().As<IZohoDeskApi>().InstancePerLifetimeScope();

            builder.RegisterType<CreditCardInfoService>().As<ICreditCardInfoService>()
          .WithParameter(ResolvedParameter.ForNamed<ICacheManager>("nop_cache_static"))
          .InstancePerLifetimeScope();
