...
namespace Nop.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        protected virtual void PrepareCustomerModel(CustomerModel model, Customer customer, bool excludeProperties)
        {
            ...
            if (customer != null)
            {
                var zohoContact = _zohoContactRepository.Table.Where(x => x.zohoContactEmail == customer.Email).FirstOrDefault();
                if (zohoContact != null)
                {
        ...
        public virtual void CreateUpdateZohoContact(CustomerModel model,Customer customer) {
