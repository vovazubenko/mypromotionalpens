...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        protected virtual void PrepareCategoryMappingModel(ProductModel model, Product product, bool excludeProperties)
        {
            ...
            var allCategories = SelectListHelper.GetCategoryList(_categoryService, _cacheManager, true).OrderBy(x => x.Text).ToList();
        ...
        protected virtual void PrepareAddProductAttributeCombinationModel(AddProductAttributeCombinationModel model, Product product)
        {
            ...
            foreach (var attribute in attributes)
            {
                ...
                if (attribute.ShouldHaveValuesAdmin())
                {
                    //values
        ...
        public virtual ActionResult ProductList(DataSourceRequest command, ProductListModel model)
        {
            ...
            var products = _productService.SearchProducts(
                ...
                showHidden: true,
                overridePublished: overridePublished, fromUtc: createdOnFromValue, toUtc:createdToFromValue, IsASI:model.SearchASINewProduct
            );
        ...
        public virtual ActionResult Create(ProductModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // custom full description
                product.FullDescription = product.ShortDescription + "<br/>";
                if (!string.IsNullOrEmpty(product.Material))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.Material") + product.Material + "<br/>";
                if (!string.IsNullOrEmpty(product.Size))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.Size") + product.Size + "<br/>";
                if (!string.IsNullOrEmpty(product.ImprintType))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.ImprintType") + product.ImprintType + "<br/>";
                if (!string.IsNullOrEmpty(product.InkColor))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.InkColor") + product.InkColor + "<br/>";
                if (!string.IsNullOrEmpty(product.ImprintArea))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.ImprintArea") + product.ImprintArea + "<br/>";
                if (!string.IsNullOrEmpty(product.MultiColorImprintAvailable))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.MultiColorImprintAvailable") + product.MultiColorImprintAvailable + "<br/>";
                if (!string.IsNullOrEmpty(product.PriceIncludes))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.PriceIncludes") + product.PriceIncludes + "<br/>";
                if (!string.IsNullOrEmpty(product.NormalProductionDays))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.NormalProductionDays") + product.NormalProductionDays + "<br/>";
                if (!string.IsNullOrEmpty(product.RushProductionDays))
                    product.FullDescription = product.FullDescription + _localizationService.GetResource("Product.Fulldescription.RushProductionDays") + product.RushProductionDays + "<br/>";
        ...
        public virtual ActionResult Edit(ProductModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                product.MarkAsNewASI = model.MarkAsNewASI;
                product.UpdatedOnUtc = DateTime.UtcNow;
