    ...
    public partial class CategoryController : BaseAdminController
    {
        ...
        public virtual ActionResult Create(CategoryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.Banner1 > 0)
                {
                    _categoryService.InsertCategoryBanner(new CategoryBanner
                    {
                        BannerId = model.Banner1,
                        CategoryId = category.Id,
                        BannerNumber = 1,
                        BannerUrl = model.Banner1Url,
                        DisplayOrder = 0,
                    });
                }
                //banner 2
                if (model.Banner2 > 0)
                {
                    _categoryService.InsertCategoryBanner(new CategoryBanner
                    {
                        BannerId = model.Banner2,
                        CategoryId = category.Id,
                        BannerNumber = 2,
                        BannerUrl = model.Banner2Url,
                        DisplayOrder = 0,
                    });
                }
                //banner 3
                if (model.Banner3 > 0)
                {
                    _categoryService.InsertCategoryBanner(new CategoryBanner
                    {
                        BannerId = model.Banner3,
                        CategoryId = category.Id,
                        BannerNumber = 3,
                        BannerUrl = model.Banner3Url,
                        DisplayOrder = 0,
                    });
                }
        ...
        public virtual ActionResult Edit(int id)
        {
            ...
            var prevCategoryBanner2 = categoryBanners.Where(x => x.BannerNumber == 2).FirstOrDefault();
            var prevCategoryBanner3 = categoryBanners.Where(x => x.BannerNumber == 3).FirstOrDefault();
            if (prevCategoryBanner1 != null) {
                model.Banner1 = prevCategoryBanner1.BannerId;
                model.Banner1Url = prevCategoryBanner1.BannerUrl;
            }
            if (prevCategoryBanner2 != null) {
                model.Banner2 = prevCategoryBanner2.BannerId;
                model.Banner2Url = prevCategoryBanner2.BannerUrl;
            }
            if (prevCategoryBanner3 != null) {
                model.Banner3 = prevCategoryBanner3.BannerId;
                model.Banner3Url = prevCategoryBanner3.BannerUrl;
            }
            return View(model);
        }
        ...
        public virtual ActionResult Edit(CategoryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //delete an old picture (if deleted or updated)
                if (prevBannerId > 0 && prevBannerId != category.bannerid)
                {
                    var prevBanner = _pictureService.GetPictureById(prevBannerId);
                    if (prevBanner != null)
                        _pictureService.DeletePicture(prevBanner);
                }
                ...
                else
                {
                    if (model.Banner1 == 0)
                    {
                        var picture = _pictureService.GetPictureById(prevCategoryBanner1.BannerId);
                        if (picture != null)
                            _pictureService.DeletePicture(picture);
                    }
                    else if (model.Banner1 > 0)
                    {
                        int prevBanner1Id = prevCategoryBanner1.BannerId;
                        prevCategoryBanner1.BannerId = model.Banner1;
                        prevCategoryBanner1.BannerUrl = model.Banner1Url;
                        _categoryService.UpdateCategoryBanner(prevCategoryBanner1);
                        if (model.Banner1 != prevBanner1Id)
                        {
                            var picture = _pictureService.GetPictureById(prevBanner1Id);
                            if (picture != null)
                                _pictureService.DeletePicture(picture);
                        }
                    }
                ...
                else
                {
                    if (model.Banner2 == 0)
                    {
                        var picture = _pictureService.GetPictureById(prevCategoryBanner2.BannerId);
                        if (picture != null)
                            _pictureService.DeletePicture(picture);
                    }
                    else if (model.Banner2 > 0)
                    {
                        int prevBanner2Id = prevCategoryBanner2.BannerId;
                        prevCategoryBanner2.BannerId = model.Banner2;
                        prevCategoryBanner2.BannerUrl = model.Banner2Url;
                        _categoryService.UpdateCategoryBanner(prevCategoryBanner2);
                        if (model.Banner2 != prevBanner2Id)
                        {
                            var picture = _pictureService.GetPictureById(prevBanner2Id);
                            if (picture != null)
                                _pictureService.DeletePicture(picture);
                        }
                    }
                ...
                else
                {
                    if (model.Banner3 == 0)
                    {
                        var picture = _pictureService.GetPictureById(prevCategoryBanner3.BannerId);
                        if (picture != null)
                            _pictureService.DeletePicture(picture);
                    }
                    else if (model.Banner3 > 0)
                    {
                        int prevBanner3Id = prevCategoryBanner3.BannerId;
                        prevCategoryBanner3.BannerId = model.Banner3;
                        prevCategoryBanner3.BannerUrl = model.Banner3Url;
                        _categoryService.UpdateCategoryBanner(prevCategoryBanner3);
                        if (model.Banner3 != prevBanner3Id)
                        {
                            var picture = _pictureService.GetPictureById(prevBanner3Id);
                            if (picture != null)
                                _pictureService.DeletePicture(picture);
                        }
                    }
        ...
        [HttpPost]
        public virtual ActionResult CategoryBannerList(DataSourceRequest command, int categoryId)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedKendoGridJson();

            var categoryBanners = _categoryService.GetCategoryBannerByCategoryId(categoryId).Where(x=>x.BannerNumber==0).ToList();
            var categoryBannersModel = categoryBanners
                .Select(x =>
                {
                    var picture = _pictureService.GetPictureById(x.BannerId);
                    if (picture == null)
                        throw new Exception("Picture cannot be loaded");
                    var m = new CategoryModel.CategoryBannerModel
                    {
                        Id = x.Id,
                        CategoryId = x.CategoryId,
                        BannerId = x.BannerId,
            ...
            var gridModel = new DataSourceResult
            {
                Data = categoryBannersModel,
                Total = categoryBannersModel.Count
            };
        ...
        [ValidateInput(false)]
        public virtual ActionResult CategoryBannerAdd(int bannerId, int displayOrder,
           string overrideAltAttribute, string overrideTitleAttribute,
           int categoryId,string bannerUrl)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageCategories))
                return AccessDeniedView();
            ...
            var picture = _pictureService.GetPictureById(bannerId);
            if (picture == null)
            ...
            _pictureService.SetSeoFilename(bannerId, _pictureService.GetPictureSeName(category.Name));
        ...
        [HttpPost]
        public virtual ActionResult CategoryBannerUpdate(CategoryModel.CategoryBannerModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageCategories))
                return AccessDeniedView();

            var categoryBanner = _categoryService.GetCategoryBannerById(model.Id);
            if (categoryBanner == null)
                throw new ArgumentException("No category banner found with the specified id");


            var picture = _pictureService.GetPictureById(categoryBanner.BannerId);
            if (picture == null)
                throw new ArgumentException("No picture found with the specified id");
            ...
            categoryBanner.DisplayOrder = model.DisplayOrder;
            categoryBanner.BannerUrl = model.BannerUrl;
            _categoryService.UpdateCategoryBanner(categoryBanner);

            return new NullJsonResult();
        }

        [HttpPost]
        public virtual ActionResult CategoryBannerDelete(int id)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageCategories))
                return AccessDeniedView();

            var categoryBanner = _categoryService.GetCategoryBannerById(id);
            if (categoryBanner == null)
                throw new ArgumentException("No category banner found with the specified id");

            var categoryId = categoryBanner.CategoryId;

            var bannerId = categoryBanner.BannerId;
            _categoryService.DeleteCategoryBanner(categoryBanner);
