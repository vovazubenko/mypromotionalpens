    ...
    public partial class ShippingController : BaseAdminController
	{
        ...
        public virtual ActionResult CreateMethod(ShippingMethodModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Dictionary<string, decimal> dictShippingRate = new Dictionary<string, decimal>();
                Dictionary<string, string> dictShippingRateCarrierName = new Dictionary<string, string>();
                dictShippingRate.Add(Convert.ToString(sm.Id),0);
                dictShippingRateCarrierName.Add(Convert.ToString(sm.Id),sm.Name);
                _shippingService.InsertAllShippingRates(dictShippingRate,false, dictShippingRateCarrierName, "FixedOrByWeight");
        ...
        public virtual ActionResult DeleteMethod(int id)
        {
            ...
            _shippingService.DeleteShippingRatesByCarrierNameID("FixedOrByWeight",Convert.ToString(sm.Id));
