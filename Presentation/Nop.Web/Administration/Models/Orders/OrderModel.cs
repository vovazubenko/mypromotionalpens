...
namespace Nop.Admin.Models.Orders
{
    public partial class OrderModel : BaseNopEntityModel
    {
        ...
        public OrderModel()
        {
            ...
            AvailableMarketingChannel = new List<SelectListItem>();
            CheckoutAttributes=new List<CheckoutAttributeModel>();
            AvailAbleCreditCards= new List<SelectListItem>();
            AvailAbleCreditCards1 = new List<SelectListItem>();
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.OrderBaseAmount")]
        public string OrderBaseAmount { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.OrderBaseAmount")]
        public decimal OrderBaseAmountValue { get; set; }
        ...
        public IList<OrderTransactionsModel> OrderTransactions { get; set; }
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.OrderNumber")]
        ...
        public partial class OrderItemModel : BaseNopEntityModel
        {
            ...
            public string CustomPictureThumbnailUrl { get; set; }
            ...
            public decimal UnitPriceExclTaxValueWithoutdiscount { get; set; }
            public string UnitPriceExclTaxWithoutdiscount { get; set; }
            ...
            public decimal DiscountExclTaxValuePerQty { get; set; }
            public string DiscountExclTaxPerQty { get; set; }
        ...
        public partial class OrderTransactionsModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransferAmount")]
            public string TransferAmountValue { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.IsCredit")]
            public bool IsCredit { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransferStatus")]
            public string TransferStatus { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransferNote")]
            public string TransferNote { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransactionId")]
            public string TransactionId { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransactionCode")]
            public string TransactionCode { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransactionResult")]
            public string TransactionResult { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.TransferType")]
            public string TransferType { get; set; }
            [NopResourceDisplayName("Admin.Orders.OrderTransactions.Fields.CreatedOnUtc")]
        ...
        public partial class AddOrderProductModel : BaseNopModel
        {
            ...
            public partial class ProductDetailsModel : BaseNopModel
            {
                ...
                [NopResourceDisplayName("Admin.Orders.Products.AddNew.SetupFee")]
        ...
        #endregion
        [NopResourceDisplayName("Admin.Orders.Fields.POInHandDate")]
        //[UIHint("DateNullable")]
        public string POInHandDate { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.ShipByDate")]
        //[UIHint("DateNullable")]
        public string ShipByDate { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.POSentDate")]
        //[UIHint("DateNullable")]
        public string POSentDate { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.CustInHandDate")]
        //[UIHint("DateNullable")]
        public string CustInHandDate { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.Supplier")]
        public string Supplier { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.OrderCost")]
        public string OrderCost { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.MarketingChannelId")]
        public string MarketingChannelId { get; set; }

        public IList<SelectListItem> AvailableMarketingChannel { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.zohoweburl")]
        public string zohoweburl { get; set; }
        public IList<CheckoutAttributeModel> CheckoutAttributes { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.OrderDifference")]
        public decimal OrderDifference { get; set; }

        [Required(ErrorMessage ="Please enter amount")]
        public decimal DifferenceAmount { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.TransactionNote")]
        [AllowHtml]
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.TransactionType")]
        public string TransactionType { get; set; }

        
        public IList<SelectListItem> AvailAbleCreditCards { get; set; }
        public IList<SelectListItem> AvailAbleCreditCards1 { get; set; }

        

        [NopResourceDisplayName("Admin.Orders.Fields.CrediCards")]
        public int CreditCardId { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.CrediCards")]
        public int CreditCardId1 { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.PaymentTypeId")]
        public string PaymentTypeId { get; set; }

        public IList<SelectListItem> AvailablePaymentType { get; set; }

        public IList<SelectListItem> PaymentMethods { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.SelectedPaymentMethod")]
        public string SelectedPaymentMethod { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.CheckMoneyNumber")]
        public string CheckMoneyNumber { get; set; }

        public bool isDisplay { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.ChargeRefundSummaryTotal")]
        public string ChargeRefundSummaryTotal { get; set; }

        public int ResendInvoiceTo { get; set; }
        public string ResendInvoiceEmail { get; set; }
    }
    ...
    public enum ResendInvoiceTo {
        [Description("Zoho/admin")]
        Admin =1,
