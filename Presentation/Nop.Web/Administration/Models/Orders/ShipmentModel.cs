...
namespace Nop.Admin.Models.Orders
{
    public partial class ShipmentModel : BaseNopEntityModel
    {
        public ShipmentModel()
        {
            ...
            this.AvailableShipmentMethods = new List<SelectListItem>();
            this.AvailableTrackShipmentMethods= new List<SelectListItem>();
        }
        ...
        [NopResourceDisplayName("Admin.Orders.Shipments.ShippingRateComputationMethodSystemName")]
        public string ShippingRateComputationMethodSystemName { get; set; }

        public IList<SelectListItem> AvailableShipmentMethods { get; set; }
        [NopResourceDisplayName("Admin.Orders.Shipments.shippingcost")]
        public decimal shippingcost { get; set; }

        [NopResourceDisplayName("Admin.Orders.Shipments.TrackShippingMethod")]
        public string TrackShippingMethod { get; set; }
        [NopResourceDisplayName("Admin.Orders.Shipments.TrackShippingRateComputationMethodSystemName")]
        public string TrackShippingRateComputationMethodSystemName { get; set; }
        public IList<SelectListItem> AvailableTrackShipmentMethods { get; set; }
    }
}