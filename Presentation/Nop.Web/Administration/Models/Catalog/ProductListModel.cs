...
namespace Nop.Admin.Models.Catalog
{
    public partial class ProductListModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.List.SearchASINewProduct")]
        public bool SearchASINewProduct { get; set; }

        [NopResourceDisplayName("Admin.System.Products.List.CreatedOnFrom")]
        [UIHint("DateNullable")]
        public DateTime? CreatedOnFrom { get; set; }

        [NopResourceDisplayName("Admin.System.Products.List.CreatedOnTo")]
        [UIHint("DateNullable")]
