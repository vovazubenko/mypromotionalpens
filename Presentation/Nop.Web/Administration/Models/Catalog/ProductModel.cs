...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MarkAsNewASI")]
        public  bool MarkAsNewASI { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Size")]
        [AllowHtml]
        public string Size { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ImprintType")]
        [AllowHtml]
        public string ImprintType { get; set; }


        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ImprintArea")]
        [AllowHtml]
        public string ImprintArea { get; set; }


        [NopResourceDisplayName("Admin.Catalog.Products.Fields.InkColor")]
        [AllowHtml]
        public string InkColor { get; set; }


        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MultiColorImprintAvailable")]
        [AllowHtml]
        public string MultiColorImprintAvailable { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PriceIncludes")]
        [AllowHtml]
        public string PriceIncludes { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.NormalProductionDays")]
        [AllowHtml]
        public string NormalProductionDays { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.RushProductionDays")]
        [AllowHtml]
