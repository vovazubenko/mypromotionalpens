...
namespace Nop.Admin.Models.Settings
{
    public partial class GeneralCommonSettingsModel : BaseNopModel
    {
        ...
        public partial class StoreInformationSettingsModel : BaseNopModel
        {
            ...
            [NopResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.FilterSiteMapSpecificationAttributeOption")]
            public string FilterSiteMapSpecificationAttributeOption { get; set; }
            [NopResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.FilterSiteMapSpecificationAttributeOptionValue")]
            public string FilterSiteMapSpecificationAttributeOptionValue { get; set; }
        }
