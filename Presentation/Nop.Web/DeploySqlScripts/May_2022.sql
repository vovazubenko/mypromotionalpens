...
GO
CREATE PROCEDURE dbo.ProductLoadAllPagedInstantSearch
(
...
BEGIN
	...
	DECLARE @sql nvarchar(max), @sql_orderby nvarchar(125);
	...
	PRINT (@sql)
	EXEC sp_executesql @sql, @params=N'@Keywords nvarchar(4000)', @Keywords=@Keywords;
END
GO
