(function ($, ss) {
    ...
    function handleReponsiveHeaderLinks() {
        ...
        $(document).on('themeBreakpointPassed7Spikes', function (e) {
            ...
            if (e.isMobileResolution) {
                ...
                if (e.isInitialLoad === false) {
                    ...
                    $(".filtersPanel").find($('.side-2 .page-title')).remove();
                    $('.side-2').prepend(pageTitle);
                    $(".filtersPanel").detach(pageTitle);
                }
            }
        ...
        //speed filter start
        $(".close-filters1").click(function () {
            $('.fns-speedfilters').removeClass('open');
            ...
            pageTitle.detach();
            $(".filtersPanel1").prepend(pageTitle);
        });
        $('.responsive-nav-wrapper .filters-button-new').on('click', function () {
            
            if ($('.fns-speedfilters').hasClass(open)) {
                $('.fns-speedfilters').removeClass('open');
                $('.overlayOffCanvas').fadeOut(function () {
                    $(this).removeClass('show');
                    $('.admin-header-links, .responsive-nav-wrapper-parent').css('z-index', '');
    ...
    function handleHomePageRichBlogCarousel(numberOfItemsToRotate) {
        var richBlogCarousel = $('.latest-blog-section .rich-blog-homepage .blog-posts');
    ...
    function handleFlyoutCartScrolling(isInitialLoad) {
        ...
        miniShoppingCartItems.css('max-height', newItemsHeight-70 + 'px');
