...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("virtual-proof-request",
                            "virtual-proof-request/",
                            new { controller = "Product", action = "ProofRequestForm" },
                            new[] { "Nop.Web.Controllers" });

            //Quote Request form

            routes.MapLocalizedRoute("quote-request",
                            "quote-request/",
                            new { controller = "Product", action = "QuoteRequestForm" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("SampleCart",
                            "samplecart/",
                            new { controller = "ShoppingCart", action = "SampleCart" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("PaymentInfo",
                        ...
                        new { controller = "Customer", action = "CustomerCreditCards" },
                        new[] { "Nop.Web.Controllers" });
            //contact us
            ...
            routes.MapLocalizedRoute("SampleRequestCheckout",
                            "samplerequestcheckout/",
                            new { controller = "Checkout", action = "sampleRequest" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CheckoutOnePage",
                            "onepagecheckout/",
                            new { controller = "Checkout", action = "OnePageCheckout" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("SampleCheckoutOnePage",
                           "sampleonepagecheckout/",
                           new { controller = "Checkout", action = "SampleOnePageCheckout" },
                           new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CheckoutSampleShippingAddress",
                            "checkout/sampleshippingaddress",
                            new { controller = "Checkout", action = "SampleShippingAddress" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("SampleCheckoutBillingAddress",
                           "checkout/samplebillingaddress",
                           new { controller = "Checkout", action = "SampleRequestBillingAddress" },
                           new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CheckoutSampleShippingMethod",
                            "checkout/sampleshippingmethod",
                            new { controller = "Checkout", action = "SampleShippingMethod" },
                            new[] { "Nop.Web.Controllers" });
