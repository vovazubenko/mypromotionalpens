...
namespace Nop.Web.Factories
{
    ...
    public partial interface IShoppingCartModelFactory
    {
        ...
        MiniShoppingCartModel PrepareMiniSampleCartModel();
        ...
        OrderTotalsModel PrepareOrderTotalsModel(IList<ShoppingCartItem> cart, bool isEditable,bool isSampleRequest);
