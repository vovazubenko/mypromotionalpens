...
namespace Nop.Web.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        public virtual CustomerNavigationModel PrepareCustomerNavigationModel(int selectedTabId = 0)
        {
            ...
            if (_orderSettings.IsReOrderAllowed)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "CustomerOrders",
                    Title = _localizationService.GetResource("Order.Reorder"),
                    Tab = CustomerNavigationEnum.Orders,
                    ItemClass = "customer-orders"
                });
            }
            ...
            if (_customerSettings.AllowCustomerManageCreditCard)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "PaymentInfo",
                    Title = _localizationService.GetResource("Account.PaymentInformation"),
                    Tab = CustomerNavigationEnum.PaymentInformation,
                    ItemClass = "customer-paymentinformation"
                });
            }
