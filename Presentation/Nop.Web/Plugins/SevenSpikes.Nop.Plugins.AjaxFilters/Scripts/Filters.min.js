(FiltersManager = function () {
    ...
    (function (e, t, r) {
        ...
        function s() {
            return o(e(".nopAjaxFilters7Spikes").attr("data-viewOptionsDropDownSelector") || ".products-viewmode, .viewmode-icon");
        }
        function l(t) {
        ...
        function c(t) {
            ...
            var rHtml = jQuery(t.currentTarget).html();

            if (emptyString(r) && !emptyString(rHtml)) {
                r = rHtml;
            };
        ...
        function emptyString(str) {
            var res = typeof str == 'undefined' || !str || str.length === 0 || str === "" || !/[^\s]/.test(str) || /^\s*$/.test(str) || str.replace(/\s/g, "") === "";
            return res;
        }
        function p() {
        ...
        function f() {
            if (0 === e(".infinite-scroll-loader").length) {
                ...
                0 === t.length && (t = p()), t.append('<div class="infinite-scroll-loader">' + e(".nopAjaxFilters7Spikes").attr("data-infinitescrollloadertext") + "</div>");
            }
        }
        function h(t, o) {
            a(".sortOptionsDropDown", t), o && (i() && e.address.history(!0), new r().requestProductsForSelectedFilters());
        }
        function g(e, t) {
            a(".viewOptionsDropDown", e), t && new r().requestProductsForSelectedFilters(void 0, void 0, void 0, void 0, void 0, !0);
        }
        function v(e, t) {
            a(".productsPageSizeDropDown", e), t && new r().requestProductsForSelectedFilters();
        }
        function F(t, r) {
            t.each(function () {
                var t = "",
                ...
                if (!e(this).is("select")) {
                    var o = ".";
                    return null != a[0] && a[0].Selected ? (o += a[0].Value.toLowerCase()) : null != a[1] && a[1].Selected && (o += a[1].Value.toLowerCase()), void e(s()).removeClass("selected").filter(o).addClass("selected");
                }
        ...
        function S() {
            var t = e(o(e(".nopAjaxFilters7Spikes").attr("data-sortOptionsDropDownSelector") || ".products-orderby"));
            0 !== t.length &&
                (t
                    ...
                    F(t, "#availableSortOptionsJson"));
        }
        function P() {
            var t = e(o(e(".nopAjaxFilters7Spikes").attr("data-productsPageSizeDropDownSelector") || ".products-pagesize"));
            0 !== t.length &&
                (t
                ...
                (t.is("select")
                    ...
                    : (t.filter(".grid").attr("data-dropdownoptionvalue", "grid"),
                        ...
                        t.on("click", function (r) {
                            r.preventDefault(), e(this).hasClass("selected") || (t.removeClass("selected"), e(this).addClass("selected"), g(e(this).attr("data-dropdownoptionvalue"), !0));
                        })),
        ...
        e.fn.extend({
            ...
            (r.prototype.requestProductsForSelectedFilters = function (a, o, s, l, c, p, u) {
                if (!r.waitForAjaxRequest && "#/noFilterApplied" !== l) {
                    a && o && i() && e.address.history(!0), (this.isProductRefreshTriggeredByScroll = u || !1), null == l ? (l = "") : (p = !0), this.setSpecificationFilterSelection(a, o);
                    ...
                    null == s && (s = null);
                    var P = e(".sortOptionsDropDown").val() || 0,
                        x = d(),
                        m = e(".productsPageSizeDropDown").val() || 0,
                        y = t.getUrlVar("pageNumber");
                    null == y || null != s || (null != c && !1 !== c) || (s = y), null == p && (p = !1);
                    ...
                    (r.waitForAjaxRequest = !0),
                        e
                            .ajax({ cache: !1, type: "POST", data: e.toJSON(k), contentType: "application/json; charset=utf-8", url: A })
                            .done(function (t) {
                                if (("" !== l && (w.changeViewModeOrderByAndPageSize(t), w.setPriceRangeValues(t)), w.refreshProducts(t, w.isProductRefreshTriggeredByScroll))) {
                                    if ((w.refreshFilters(t), w.refreshProductsPager(t), w.refreshClearButtons(), "NO HASH QUERY" !== l)) {
                                        w.expandFilterPanelsWithSelectedOptions();
                                        var i = e(t).filter("#urlHashQuery").val().toString();
                                        "" !== i ? (w.isProductRefreshTriggeredByScroll && (i = i.slice(0, i.indexOf("&pageNumber"))), e.address.value(i)) : e.address.value("noFilterApplied");
                                    }
                                    w.hideProductPanelAjaxBusy(), (r.waitForAjaxRequest = !1);
                                    var a = e(".nopAjaxFilters7Spikes").attr("data-scrollToElement");
                                    if (!w.isProductRefreshTriggeredByScroll && null != a && "true" === a.toLowerCase()) {
                                        var o = e(".nopAjaxFilters7Spikes").attr("data-scrollToElementSelector").split(","),
                                            s = ".product-selectors";
                                        if (null != o && o.length > 0) {
                                            for (var d = 0; d < o.length; d++)
                                                if (e(o[d].trim()).length > 0) {
                                                    s = o[d].trim();
                                                    break;
                                                }
                                            e(s).length > 0 && e("html, body").animate({ scrollTop: e(s).offset().top }, "slow");
                                        }
                                    }
                                    e(".productPanelAjaxBusy").length < 1 && w.addProductPanelAjaxBusyToPage();
                                    var c = e(t).filter("#totalCount").val().toString();
                                    if (
                                        (e.event.trigger({ type: "nopAjaxFiltersFiltrationCompleteEvent", totalCount: c }),
                                            "true" === e(".nopAjaxFilters7Spikes").attr("data-showSelectedFiltersPanel").toLowerCase() && n(),
                                        ...
                                        e(".page-body .product-grid:not(.featured-product-grid, .nop-jcarousel)").length > 0
                                            ? (p = e(".page-body .product-grid:not(.featured-product-grid, .nop-jcarousel) .item-box").length)
                                            : e(".page-body .product-list").length > 0 && (p = e(".page-body .product-list .item-box").length),
                                            (function (t, r) {
                            ...
                            .fail(function () {
                                w.hideProductPanelAjaxBusy(), alert("Loading the page failed."), (r.waitForAjaxRequest = !1);
                            })
                            .always(function () {
                                (w.isProductRefreshTriggeredByScroll = !1), i() && e.address.history(!1);
                            });
                }
            }),
            ...
            (r.prototype.refreshProducts = function (t, r) {
                var i,
                    a = d() || e(".nopAjaxFilters7Spikes").attr("data-defaultViewMode"),
                ...
                if (null != e(t).filter(o).html()) {
                    if ((s.length > 1 && (s = s.last()), r)) {
                        var l = e(t).filter(o),
                            n = l.find(".item-box");
                        l.hasClass("product-grid") ? s.hasClass("product-list") && s.removeClass("product-list").addClass("product-grid") : s.hasClass("product-grid") && s.removeClass("product-grid").addClass("product-list"),
                            e(".infinite-scroll-loader").hide(),
                            s.find(".item-box").last().after(n);
                    } else 0 == s.length && (s = $(".product-grid")), s.replaceWith(e(t).filter(o));
                    i = !0;
                } else
                    this.hideProductPanelAjaxBusy(),
                        e("#nopAjaxFiltersNoProductsDialog").length > 0 ? this.showNoProductsModalDialog() : (s.prepend(e(t).filter("#nopAjaxFiltersNoProductsDialog")), this.showNoProductsModalDialog()),
                        (i = !1);
                return i;
            }),
            ...
            (r.prototype.clearFilterOptionsForFiltersGroupElement = function (e) {
                ...
                t.length > 0 && t.find(".select-inner").text(t.find("select option:selected").text()), this.requestProductsForSelectedFilters(e, void 0);
            }),
            ...
            (r.prototype.clearAllFilterOptions = function (t) {
                e(".nopAjaxFilters7Spikes .filtersGroupPanel").find("[data-option-ids]").removeAttr("checked selected"),
            ...
            (r.prototype.refreshClearButtons = function () {
                ...
                e(".nopAjaxFilters7Spikes .filtersGroupPanel").each(function () {
                    ...
                    r.find("[data-option-ids]").each(function () {
                        var t = e(this);
                        if (null != (t.attr("selected") || t.attr("checked"))) return (i = !0), !1;
                    });
            ...
            (r.prototype.changeViewModeOrderByAndPageSize = function (t) {
                var r = e(t).filter("#currentPageSizeJson").val(),
                    i = e.parseJSON(r),
                    o = e(t).filter("#currentOrderByJson").val(),
                    l = e.parseJSON(o),
                    n = e(t).filter("#currentViewModeJson").val(),
                    d = e.parseJSON(n);
                a(".sortOptionsDropDown", l),
            ...
            (r.prototype.refreshFilters = function (t) {
                ...
                var p = e(t).filter("#onSaleFilterModel7SpikesJson").val().toString(),
                    u = e.parseJSON(p);
                r.refreshOnSaleFilters(u, r.filtersUIMode),
                    e(".nopAjaxFilters7Spikes .filtersGroupPanel").each(function () {
                        var t = e(this),
                            r = !0;
            ...
            (r.prototype.addProductPanelAjaxBusyToPage = function () {
                var t = p();
                t.addClass("ajaxBusyPanelParent " + A), t.css("position", "relative"), t.append(e('<div class="productPanelAjaxBusy"></div><div class="clear"></div>')), e(".productPanelAjaxBusy").hide(), f();
            }),
            ...
            (r.prototype.showNoProductsModalDialog = function () {
                ...
                r || (r = "NO RESULTS FOUND"),
                    t ||
                    (t = e("#nopAjaxFiltersNoProductsDialog")
            ...
            (r.addStateClassToCheckBoxParent = function (e, t) {
                var r = e.parent("li");
                0 !== r.length && ((t !== y && t !== k) || (r.addClass("checked"), t === y && r.removeClass("disabled")), (t !== k && t !== w) || r.addClass("disabled"), t === m && r.removeClass("checked disabled"));
            }),
            (r.addStateAttributesToOption = function (e, t, r) {
                (t !== y && t !== k) || (r ? e.attr("selected", "selected").trigger("change") : e.attr("checked", "checked"), t === y && e.removeAttr("disabled")),
                    (t !== k && t !== w) || e.attr("disabled", "disabled"),
                    t === m && e.removeAttr("checked selected disabled");
            }),
            (r.addStateClassAndAttributesToOption = function (e, t, i) {
                var a = !1;
                return t === y && (a = !0), i || r.addStateClassToCheckBoxParent(e, t), r.addStateAttributesToOption(e, t, i), a;
            }),
            e(document).ready(function () {
                ...
                "true" === e(".nopAjaxFilters7Spikes").attr("data-enableinfinitescroll").toLowerCase() &&
                    ...
                    null == e("body").attr("nosimpleselect") && e(".filtersPanel select").simpleSelect();
            }),
            e(window).unload(function () {
                i() && e.address.history(!0);
            }),
            e(document).ready(function () {
                x(), i() && e.address.history(!1);
            });
                ...
                if (!r.waitForAjaxRequest && "#/noFilterApplied" !== l) {
                    ...
                    (r.waitForAjaxRequest = !0),
                        e
                            .ajax({ cache: !1, type: "POST", data: e.toJSON(k), contentType: "application/json; charset=utf-8", url: A })
                        .done(function (t) {
                            var locationBeforeChanges = window.location.href;
                            var pageNumberBeforeChanges = 1;
                            var splittedResBeforeChanges = locationBeforeChanges.split("pageNumber=");
                            if (splittedResBeforeChanges.length > 1) {
                                pageNumberBeforeChanges = parseInt(splittedResBeforeChanges[splittedResBeforeChanges.length - 1]);
                            };
                                if (("" !== l && (w.changeViewModeOrderByAndPageSize(t), w.setPriceRangeValues(t)), w.refreshProducts(t, w.isProductRefreshTriggeredByScroll))) {
                                    if ((w.refreshFilters(t), w.refreshProductsPager(t), w.refreshClearButtons(), "NO HASH QUERY" !== l)) {
                                        w.expandFilterPanelsWithSelectedOptions();
                                    ...
                                    var locationAfterChanges = window.location.href;
                                    var pageNumberAfterChanges = 1;
                                    var splittedResAfterChanges = locationAfterChanges.split("pageNumber=");
                                    if (splittedResAfterChanges.length > 1) {
                                        pageNumberAfterChanges = parseInt(splittedResAfterChanges[splittedResAfterChanges.length - 1]);
                                    };

                                    if (pageNumberBeforeChanges != pageNumberAfterChanges) {
                                        $("html,body").animate({ scrollTop: 0 }, 10);
                                    };
                                } else r.waitForAjaxRequest = !1;
                            })
