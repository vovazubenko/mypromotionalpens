...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Category : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<CategoryBanner> _categoryBanners;
        /// <summary>
        ...
        public virtual ICollection<CategoryBanner> CategoryBanners
        {
            get { return _categoryBanners ?? (_categoryBanners = new List<CategoryBanner>()); }
            protected set { _categoryBanners = value; }
        }
