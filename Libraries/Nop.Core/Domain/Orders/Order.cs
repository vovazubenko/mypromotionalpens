...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        private ICollection<OrderTransactions> _orderTransactions;
        ...
        public virtual ICollection<OrderTransactions> OrderTransactions
        {
            get { return _orderTransactions ?? (_orderTransactions = new List<OrderTransactions>()); }
            protected set { _orderTransactions = value; }
        }
