...
namespace Nop.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public WebHelper(HttpContextBase httpContext)
        {
            ...
            this._staticFileExtensions = new[] { ".axd", ".ashx", ".bmp", ".css", ".gif", ".html", ".ico", ".jpeg", ".jpg", ".js", ".png", ".rar", ".zip" };
        }
        ...
        public virtual bool IsHtmResource(HttpRequest request)
        {
            if (request == null)
                throw new ArgumentNullException("request");
            ...
            return new[] {".htm"}.Contains(extension);
        }
