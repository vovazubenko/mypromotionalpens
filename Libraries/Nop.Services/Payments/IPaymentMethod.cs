...
namespace Nop.Services.Payments
{
    ...
    public partial interface IPaymentMethod : IPlugin
    {
        ...
        ProcessPaymentResult CreateTransaction(string customerProfileId, string customerPaymentProfileId, decimal Amount, string orderGuid,string description);
        ProcessPaymentResult RefundTransaction(string customerProfileId, string customerPaymentProfileId, decimal Amount, string orderGuid, string description);
        ...
        CustomerProfileResponse CreateCustomerProfile(Customer customer);
        CustomerProfileResponse UpdateCustomerProfile(CreditCardInfo cardInfo);
        CustomerProfileResponse DeleteCustomerProfile(string customerProfileId);
        CustomerProfileResult GetCustomerProfile(string customerProfileId);

        CustomerPaymentProfileResponse CreateCustomerPaymentProfile(CreditCardInfo paymentProfile);
        CustomerPaymentProfileResponse UpdateCustomerPaymentProfile(CreditCardInfo paymentProfile);
        CustomerPaymentProfileResponse DeleteCustomerPaymentProfile(CreditCardInfo paymentProfile);
        CustomerPaymentProfileResult GetCustomerPaymentProfile(string customerProfileId, long paymentProfileId);

        ProcessPaymentResult AuthorizeTransaction(string customerProfileId, string customerPaymentProfileId, decimal Amount, string ordernumber, string description);
