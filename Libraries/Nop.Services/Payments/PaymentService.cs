...
namespace Nop.Services.Payments
{
    ...
    public partial class PaymentService : IPaymentService
    {
        ...
        public virtual ProcessPaymentResult CreateTransaction(string paymentType,string customerProfileId, string customerPaymentProfileId, decimal Amount, string orderGuid,string description)
        {
            var paymentMethod = LoadPaymentMethodBySystemName(paymentType);
            if (paymentMethod == null)
                throw new NopException("Payment method couldn't be loaded");
            return paymentMethod.CreateTransaction(customerProfileId, customerPaymentProfileId, Amount, orderGuid, description);
        }

        public virtual ProcessPaymentResult AuthorizeTransaction(string paymentType, string customerProfileId, string customerPaymentProfileId, decimal Amount, string ordernumber, string description)
        {
            var paymentMethod = LoadPaymentMethodBySystemName(paymentType);
            if (paymentMethod == null)
                throw new NopException("Payment method couldn't be loaded");
            return paymentMethod.AuthorizeTransaction(customerProfileId, customerPaymentProfileId, Amount, ordernumber, description);
        }

        public virtual ProcessPaymentResult RefundTransaction(string paymentType,string customerProfileId, string customerPaymentProfileId, decimal Amount, string orderGuid, string description)
        {
            var paymentMethod = LoadPaymentMethodBySystemName(paymentType);
            if (paymentMethod == null)
                throw new NopException("Payment method couldn't be loaded");
            return paymentMethod.RefundTransaction(customerProfileId, customerPaymentProfileId, Amount, orderGuid, description);
        }
        /// <summary>
