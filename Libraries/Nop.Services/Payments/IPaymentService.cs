...
namespace Nop.Services.Payments
{
    ...
    public partial interface IPaymentService
    {
        ...
        #endregion
        ProcessPaymentResult CreateTransaction(string paymentType,string customerProfileId, string customerPaymentProfileId, decimal Amount, string orderGuid,string description);
        ProcessPaymentResult RefundTransaction(string paymentType,string customerProfileId, string customerPaymentProfileId, decimal Amount, string orderGuid, string description);

        ProcessPaymentResult AuthorizeTransaction(string paymentType, string customerProfileId, string customerPaymentProfileId, decimal Amount, string ordernumber, string description);
    }
}
