...
{
    public partial class SupplierTask : ITask
    {
        ...
        public SupplierTask(IASI_SuppliersUpdateStatusService supplierUpdateService
        ...
        public void Execute()
        {
            try
            {
                ...
                asi_api.GetAllSuppliers(_supplierUpdateService);
            }
            catch (Exception e)
            {
