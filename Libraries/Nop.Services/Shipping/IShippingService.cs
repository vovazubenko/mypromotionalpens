...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        IList<ShippingRates> GetShippingRates(bool isDomestic,string ShippingCarrier);
        void InsertAllShippingRates(Dictionary<string, decimal> dictShippingRates, bool IsDomestic, Dictionary<string, string> dictCarrierName,string ShippingCarrier);
        void DeleteAllShippingRates(bool isDomestic,string ShippingCarrier);
        IList<ShippingRates> GetAllShippingRates();
        void DeleteShippingRatesByCarrierNameID(string ShippingCarrier, string Carrierid);
        #endregion
    }
}
