...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        public virtual IPagedList<Category> GetAllASICategories(string categoryName = "", int storeId = 0,
         int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            if (_commonSettings.UseStoredProcedureForLoadingCategories &&
                _commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
        ...
        public virtual IList<CategoryBanner> GetCategoryBannerByCategoryId(int categoryId)
        {
            var query = from cb in _categoryBannerRepository.Table
                        where cb.CategoryId == categoryId
                        orderby cb.DisplayOrder, cb.Id
                        select cb;
            var categoryBanners = query.ToList();
            return categoryBanners;
        }
        public virtual void InsertCategoryBanner(CategoryBanner categoryBanner)
        {
            if (categoryBanner == null)
                throw new ArgumentNullException("categoryBanner");
        ...
        public virtual CategoryBanner GetCategoryBannerById(int categoryBannerId)
        {
        ...
        public virtual void UpdateCategoryBanner(CategoryBanner categoryBanner)
        {
            if (categoryBanner == null)
                throw new ArgumentNullException("categoryBanner");
        ...
        public virtual void DeleteCategoryBanner(CategoryBanner categoryBanner)
        {
            if (categoryBanner == null)
                throw new ArgumentNullException("categoryBanner");
