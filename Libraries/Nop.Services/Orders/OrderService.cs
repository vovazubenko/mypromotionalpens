...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        public virtual IPagedList<Order> SearchOrders(int storeId = 0,
            ...
            string orderNotes = null, string searchOrderNumber = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            if (!String.IsNullOrEmpty(searchOrderNumber))
                query = query.Where(o => !String.IsNullOrEmpty(o.OrderNumber) && o.OrderNumber.Contains(searchOrderNumber));
        ...
        public virtual Order GetLastOrder()
        {
            var query = from o in _orderRepository.Table
