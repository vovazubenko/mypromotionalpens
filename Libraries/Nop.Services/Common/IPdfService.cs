...
namespace Nop.Services.Common
{
    ...
    public partial interface IPdfService
    {
        ...
        #region PurchseOrder
        string PrintPurchaseOrderToPdf(PurchaseOrder purchaseOrder, int languageId = 0, int vendorId = 0);
        void PrintPurchaseOrderToPdf(Stream stream, PurchaseOrder purchaseOrder, int languageId = 0, int vendorId = 0);
        #endregion
    }
}