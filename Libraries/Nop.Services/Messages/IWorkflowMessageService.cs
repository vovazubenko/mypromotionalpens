...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        int SendProductProofRequestFormMessage(int languageId, string senderEmail,
           string senderName, string subject, string body, dynamic model);
        int SendProductQuoteRequestFormMessage(int languageId, string senderEmail,
          string senderName, string subject, string body, dynamic model);

        int SendProductSampleRequestFormMessage(int languageId, string senderEmail,
          string senderName, string subject, string body,dynamic model);

        #endregion

        #region ProductAddedToCartNotificationToCustomer
        int ProductAddedToCartNotificationToCustomer(List<ShoppingCartItem> item, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null);

        #endregion

        #region PurchaseOrder
        int SendPurchaseOrderNotification(PurchaseOrder po,string podate,string deliverydate, int languageId, string attachmentFilePath = null, string attachmentFileName = null);
        #endregion

        int SendOrderInvoiceCustomerNotification(Order order, int languageId,
         string attachmentFilePath = null, string attachmentFileName = null);

        string GetZohoOrderBody(Order order, int languageId);
        string GetOrderPlacedBody(Order order, int languageId);
        int ReSendOrderPlacedCustomerNotification(Order order, int languageId,
           string attachmentFilePath = null, string attachmentFileName = null,string resnendToEmail=null);
       int ReOrderCustomerNotification(Order order, int languageId, string ReorderComment,
         string attachmentFilePath = null, string attachmentFileName = null);

        int ReOrderStoreOwnerNotification(Order order, int languageId, string ReorderComment,
         string attachmentFilePath = null, string attachmentFileName = null);
    }
}
