...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual string ProductListToHtmlTable(Order order, int languageId, int vendorId)
        {
            ...
            if (order.PaymentStatusId != (int)PaymentStatus.SampleRequest)
            {
                sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).SetupCost", languageId)));
            }
            if (order.PaymentStatusId != (int)PaymentStatus.SampleRequest)
            {
            ...
            if (vendorId == 0)
            {
                ...
                {
                    sb.AppendLine("<tr><td style=\"text-align:right;\" colspan=\"2\">&nbsp;</td><td colspan=\"4\" style=\"text-align:right\">");
                ...
                if (order.PaymentStatusId != (int)PaymentStatus.SampleRequest)
                {
                    ...
                    if (displayPaymentMethodFee)
                    {
                        ...
                        sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"3\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, paymentMethodFeeTitle, cusPaymentMethodAdditionalFee));
                    }
                    ...
                    if (displayTaxRates)
                    {
                        foreach (var item in taxRates)
                        {
                            ...
                            sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"3\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, taxRate, taxValue));
                        }
                    }
                    ...
                    foreach (var gcuh in gcuhC)
                    {
                        ...
                        sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"3\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, giftCardText, giftCardAmount));
                    }
                    ...
                    if (order.RedeemedRewardPointsEntry != null)
                    {
                        ...
                        sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"3\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, rpTitle, rpAmount));
                    }
        ...
        protected virtual string PurchaseOrderProductListToHtmlTable(Order order, int languageId, int vendorId)
        {
            ...
            sb.AppendLine(string.Format("<tr style=\"background-color:{0};text-align:center;\">", _templatesSettings.Color1));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).Name", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product.Sku", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).Price", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).Quantity", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).SetupCost", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).Total", languageId)));
            ...
            if (vendorId == 0)
            {
                ...
                if (displayTax)
                {
                    //.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td colspan=\"3\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, _localizationService.GetResource("Messages.Order.Tax", languageId), cusTaxTotal));
                }
                if (displayTaxRates)
                {
                    //foreach (var item in taxRates)
        ...
        public virtual void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            ...
            if (language != null && !String.IsNullOrEmpty(language.LanguageCulture))
            {
                DateTime currentDate = _dateTimeHelper.ConvertToUserTime(DateTime.UtcNow, TimeZoneInfo.Utc, _dateTimeHelper.GetCustomerTimeZone(order.Customer));
                tokens.Add(new Token("Order.CurrentDate", currentDate.ToString("MM/dd/yyyy", new CultureInfo(language.LanguageCulture))));
            }
            else
            {
                tokens.Add(new Token("Order.CurrentDate", order.CreatedOnUtc.ToString("MM/dd/yyyy")));
            }
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        public virtual void AddCartTokens(IList<Token> tokens, List<ShoppingCartItem> item, int languageId, int vendorId = 0)
        {

            tokens.Add(new Token("ShoppingCart.CustomerFullName", string.Format("{0}", item.FirstOrDefault().Customer.GetFullName())));
            tokens.Add(new Token("CartURLForCustomer", string.Format("{0}cart", GetStoreUrl(item.FirstOrDefault().StoreId)), true));

            tokens.Add(new Token("Cart.Product(s)", CartToHtmlTable(item, languageId, vendorId), true));

            //event notification
            _eventPublisher.EntityTokensAdded(item.FirstOrDefault(), tokens);
        }

        protected virtual string CartToHtmlTable(List<ShoppingCartItem> item, int languageId, int vendorId)
        {
            string result;
            ...
            #region Products
            sb.AppendLine(string.Format("<tr style=\"background-color:{0};text-align:center;\">", _templatesSettings.Color1));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("ShoppingCart.Product(s)", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("ShoppingCart.UnitPrice", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("ShoppingCart.Quantity", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("ShoppingCart.ItemTotal", languageId)));
            sb.AppendLine("</tr>");
            ...
            for (int i = 0; i <= table.Count - 1; i++)
            {
                ...
                AttributeInfo = _productAttributeFormatter.FormatAttributes(orderItem.Product, orderItem.AttributesXml);
                if (!String.IsNullOrEmpty(AttributeInfo))
                {
                    sb.AppendLine("<br />");
                    sb.AppendLine(AttributeInfo);
                }
                //rental info
                if (orderItem.Product.IsRental)
                {
                ...
                if (orderItem.Product.CallForPrice)
                {
                    unitPriceStr = _localizationService.GetResource("Products.CallForPrice");
                }
                else
                {
                    decimal taxRate;

                    decimal shoppingCartUnitPriceWithDiscountBase = _taxService.GetProductPrice(orderItem.Product, _priceCalculationService.GetUnitPrice(orderItem), out taxRate);
                    decimal shoppingCartUnitPriceWithDiscount = _currencyService.ConvertFromPrimaryStoreCurrency(shoppingCartUnitPriceWithDiscountBase, _workContext.WorkingCurrency);
                    unitPriceStr = _priceFormatter.FormatPrice(shoppingCartUnitPriceWithDiscount);
                }
                sb.AppendLine(string.Format("<td style=\"padding: 0.6em 0.4em;text-align: right;\">{0}</td>", unitPriceStr));
                ...
                string priceStr = "";
                int? MaximumDiscountedQty = 0;
                string Discount = "";
                if (orderItem.Product.CallForPrice)
                {
                    priceStr = _localizationService.GetResource("Products.CallForPrice");
                }
                else
                {
                    //sub total
                    ...
                    decimal taxRate;
                    decimal shoppingCartItemSubTotalWithDiscountBase = _taxService.GetProductPrice(orderItem.Product, _priceCalculationService.GetSubTotal(orderItem, true, out shoppingCartItemDiscountBase, out scDiscounts, out maximumDiscountQty), out taxRate);
                    decimal shoppingCartItemSubTotalWithDiscount = _currencyService.ConvertFromPrimaryStoreCurrency(shoppingCartItemSubTotalWithDiscountBase, _workContext.WorkingCurrency);
                    priceStr = _priceFormatter.FormatPrice(shoppingCartItemSubTotalWithDiscount);
                    MaximumDiscountedQty = maximumDiscountQty;

                    //display an applied discount amount
                    if (shoppingCartItemDiscountBase > decimal.Zero)
                    {
                        shoppingCartItemDiscountBase = _taxService.GetProductPrice(orderItem.Product, shoppingCartItemDiscountBase, out taxRate);
                        if (shoppingCartItemDiscountBase > decimal.Zero)
                        {
                            decimal shoppingCartItemDiscount = _currencyService.ConvertFromPrimaryStoreCurrency(shoppingCartItemDiscountBase, _workContext.WorkingCurrency);
                            Discount = _priceFormatter.FormatPrice(shoppingCartItemDiscount);
                        }
                    }
                }
                sb.AppendLine(string.Format("<td style=\"padding: 0.6em 0.4em;text-align: right;\">{0}</td>", priceStr));
            ...
            var CheckoutAttributeInfo = _checkoutAttributeFormatter.FormatAttributes(checkoutAttributesXml, _workContext.CurrentCustomer);
            if (!String.IsNullOrEmpty(CheckoutAttributeInfo))
            {
                sb.AppendLine("<tr><td style=\"text-align:right;\" colspan=\"1\">&nbsp;</td><td colspan=\"3\" style=\"text-align:right\">");
                sb.AppendLine(CheckoutAttributeInfo);
                sb.AppendLine("</td></tr>");
            }
            ...
            _orderTotalCalculationService.GetShoppingCartSubTotal(item, subTotalIncludingTax,
                out orderSubTotalDiscountAmountBase, out orderSubTotalAppliedDiscounts,
                out subTotalWithoutDiscountBase, out subTotalWithDiscountBase);
            decimal subtotalBase = subTotalWithoutDiscountBase;
            decimal subtotal = _currencyService.ConvertFromPrimaryStoreCurrency(subtotalBase, _workContext.WorkingCurrency);
            cusSubTotal = _priceFormatter.FormatPrice(subtotal, true, _workContext.WorkingCurrency, _workContext.WorkingLanguage, subTotalIncludingTax);
            if (orderSubTotalDiscountAmountBase > decimal.Zero)
            {
                ...
                cusSubTotalDiscount = _priceFormatter.FormatPrice(-orderSubTotalDiscountAmount, true, _workContext.WorkingCurrency, _workContext.WorkingLanguage, subTotalIncludingTax);
            }
            ...
            bool displayShipping = item.RequiresShipping();
            if (displayShipping)
            {
                decimal? shoppingCartShippingBase = _orderTotalCalculationService.GetShoppingCartShippingTotal(item);
                if (shoppingCartShippingBase.HasValue)
                {
                    ...
                    cusShipTotal = _priceFormatter.FormatShippingPrice(shoppingCartShipping, true);

                    //selected shipping method
                    var shippingOption = _workContext.CurrentCustomer.GetAttribute<ShippingOption>(SystemCustomerAttributeNames.SelectedShippingOption, _storeContext.CurrentStore.Id);
                    if (shippingOption != null)
                        SelectedShippingMethod = shippingOption.Name;
                }
            }
            else
            {
            ...
            //payment method fee
            bool displayPaymentMethodFee = false;
            ...
            decimal paymentMethodAdditionalFee = _paymentService.GetAdditionalHandlingFee(item, paymentMethodSystemName);
            ...
            if (paymentMethodAdditionalFeeWithTaxBase > decimal.Zero)
            {
                ...
                cusPaymentMethodAdditionalFee = _priceFormatter.FormatPaymentMethodAdditionalFee(paymentMethodAdditionalFeeWithTax, true);
                displayPaymentMethodFee = paymentMethodAdditionalFeeWithTax > decimal.Zero;
            }
            ...
            {
                taxRates = new SortedDictionary<decimal, decimal>();
                decimal shoppingCartTaxBase = _orderTotalCalculationService.GetTaxTotal(item, out taxRates);
                ...
                else
                {
                    ...
                    cusTaxTotal = _priceFormatter.FormatPrice(shoppingCartTax, true, false);
                    //foreach (var tr in taxRates)
                    //{
                    //    taxRates.Add(tr.Key, _currencyService.ConvertFromPrimaryStoreCurrency(Convert.ToDecimal(tr.Value), _workContext.WorkingCurrency));
                    //}
                }
            }
            ...
            decimal? shoppingCartTotalBase = _orderTotalCalculationService.GetShoppingCartTotal(item,
            ...
            if (shoppingCartTotalBase.HasValue)
            {
                ...
                cusTotal = _priceFormatter.FormatPrice(shoppingCartTotal, true, false);
            }
            ...
            if (orderTotalDiscountAmountBase > decimal.Zero)
            {
                ...
                cusDiscount = _priceFormatter.FormatPrice(-orderTotalDiscountAmount, true, false);
                displayDiscount = true;
            }
            ...
            if (displayTaxRates)
            {
                foreach (var items in taxRates)
                {
                    string taxRate = String.Format(_localizationService.GetResource("Messages.Order.TaxRateLine"), _priceFormatter.FormatTaxRate(items.Key));
                    string taxValue = _priceFormatter.FormatPrice(items.Value, true, _workContext.WorkingCurrency.CurrencyCode, false, language);
            ...
            if (appliedGiftCards != null && appliedGiftCards.Any())
            {
                foreach (var appliedGiftCard in appliedGiftCards)
                {
                    ...
                    string giftCardText = String.Format(_localizationService.GetResource("Messages.Order.GiftCardInfo", languageId), HttpUtility.HtmlEncode(gcModel.CouponCode));
                    string giftCardAmount = _priceFormatter.FormatPrice(-amountCanBeUsed, true, false);
            ...
            //reward points
            if (redeemedRewardPointsAmount > decimal.Zero && isSampleRequest == false)
            {
                ...
                string rpTitle = string.Format(_localizationService.GetResource("Messages.Order.RewardPoints", languageId), redeemedRewardPoints);
                string rpAmount = _priceFormatter.FormatPrice(-redeemedRewardPointsAmountInCustomerCurrency, true, false);
        ...
        public virtual void AddPurchaseOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            tokens.Add(new Token("Order.OrderNumber", order.CustomOrderNumber));
            ...
            tokens.Add(new Token("Order.Product(s)", PurchaseOrderProductListToHtmlTable(order, languageId, vendorId), true));
