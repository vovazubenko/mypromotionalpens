    ...
    public partial class MessageTemplateService : IMessageTemplateService
    {
        ...
        public virtual MessageTemplate GetMessageTemplateByName(string messageTemplateName, int storeId)
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                //if (templates.FirstOrDefault() != null && messageTemplateName.ToLower()!= "ZohoDesk.OrderPlaced".ToLower())
                //{

                //    var query1 = _messageTemplateRepository.Table;
                //    query1 = query1.Where(t => t.Name.ToLower() == "HeaderTemplate".ToLower());
                //    query1 = query1.OrderBy(t => t.Id);
                //    var templates1 = query1.ToList();
                //    if (templates1.FirstOrDefault() != null)
                //    {
                //        templates.FirstOrDefault().Body = templates1.FirstOrDefault().Body + templates.FirstOrDefault().Body;
                //    }

                //    var query2 = _messageTemplateRepository.Table;
                //    query2 = query2.Where(t => t.Name.ToLower() == "FooterTemplate".ToLower());
                //    query2 = query2.OrderBy(t => t.Id);
                //    var templates2 = query2.ToList();
                //    if (templates2.FirstOrDefault() != null)
                //    {
                //        templates.FirstOrDefault().Body = templates.FirstOrDefault().Body + templates2.FirstOrDefault().Body;
                //    }
