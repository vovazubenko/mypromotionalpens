...
namespace Nop.Services.Messages
{
    public partial interface IMessageTokenProvider
    {
        ...
        void AddCartTokens(IList<Token> tokens, List<ShoppingCartItem> item, int languageId, int vendorId = 0);
        void AddPurchaseOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0);
    }
}
